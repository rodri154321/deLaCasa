...
export default function RecipeForm({ recipe, isOpen, onClose, onSubmit, isLoading = false }: RecipeFormProps) {
  ...
  return (
      <div className="modal-overlay">
        <div className="modal-content max-w-4xl animate-in zoom-in-95 duration-300">
          <div className="modal-header bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-100">
            ...
            <button onClick={onClose} className="btn-ghost hover:bg-red-50 hover:text-red-600 transition-colors duration-200" type="button">
